...
public class ZeroSheetApplication {
	...
	public CommandLineRunner dataSeeder(ItemRepository itemrepo) {
		return args -> {
			itemrepo.save(new Item(1L, "H frame 2.4", "PCS", 3.84d, 3.50d, 100, 23, 23
				));
			itemrepo.save(new Item(2L, "X-bracing ", "PCS", 3.84d, 4.50d, 120, 34, 3 
				));
			itemrepo.save(new Item(3L, "U-head", "PCS", 4.45d, 3.50d, 120, 33, 23
				));
			itemrepo.save(new Item(4L, "Base juck", "PCS", 4.85d, 3.84d, 100, 23, 12 
				));
			itemrepo.save(new Item(5L, "Connector ", "PCS", 4.45d, 3.55d, 100, 22, 12
				));
			itemrepo.save(new Item(6L, "Extention1m ", "PCS", 3.50d, 3.50d, 120, 11, 11
				));
			itemrepo.save(new Item(7L, "Extention50cm ", "PCS", 2.85d, 2.50d, 80, 12, 21
				));
			itemrepo.save(new Item(8L, "Clamp free ", "PCS", 2.5d, 2.80d, 70, 11, 0
				));
			itemrepo.save(new Item(9L, "Clamp 90°", "PCS", 2.45d, 3.50d, 90, 12, 0
				));
			itemrepo.save(new Item(10L, "Clamp connector", "PCS", 1.45d, 1.50d, 50, 0, 0
				));
			itemrepo.save(new Item(11L, "CHSØ48*3mm 6m", "PCS", 5.50d, 5.55d, 120, 0, 0
				));
			itemrepo.save(new Item(12L, "CHSØ48*2mm 2m", "PCS", 4.45d, 3.50d, 120, 0, 0
				));
			itemrepo.save(new Item(13L, "Platform board", "PCS", 8.5d, 7.50d, 100, 0, 0
				));
			itemrepo.save(new Item(14L, "Shoring Props", "PCS", 12.45d, 22.50d, 120, 0, 0
				));
			itemrepo.save(new Item(15L, "RHS 60*60*3", "PCS", 11.22d, 15.0d, 120, 0, 0
				));
		};
	}
